...
class WatchListShowAdapter : PagedListAdapter<TVShowEntity, WatchListShowAdapter.ViewHolder>(DIFF_CALLBACK) {
    companion object {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): WatchListShowAdapter.ViewHolder {
        val view = ItemMovieBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: WatchListShowAdapter.ViewHolder, position: Int) {
