...
class WatchListMovieAdapter : PagedListAdapter<MovieEntity, WatchListMovieAdapter.ViewHolder>(DIFF_CALLBACK) {
    companion object {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): WatchListMovieAdapter.ViewHolder {
        val view = ItemMovieBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: WatchListMovieAdapter.ViewHolder, position: Int) {
